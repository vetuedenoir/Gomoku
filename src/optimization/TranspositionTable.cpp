...
TranspositionTable::TranspositionTable() : _table(TABLE_SIZE) {}
...
void TranspositionTable::store(uint64_t hash, int32_t score, uint8_t depth, TTFlag flag, t_cell bestMove)
{
