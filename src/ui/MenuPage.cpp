...
void MenuPage::removeText(const std::string &key)      { _textMap.erase(key); }
void MenuPage::removeRectangle(const std::string &key) { _rectMap.erase(key); }
void MenuPage::removeItem(const std::string &key)      { _itemMap.erase(key); }
...
bool MenuPage::hasText     (const std::string &key) const { return _textMap.find(key) != _textMap.end(); }
bool MenuPage::hasRectangle(const std::string &key) const { return _rectMap.find(key) != _rectMap.end(); }
bool MenuPage::hasItem     (const std::string &key) const { return _itemMap.find(key) != _itemMap.end(); }
