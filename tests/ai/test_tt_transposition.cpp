...
TEST_CASE("[TT] transposition: different move orders share hash and TT entry")
{
	...
	p1.makeMove(5, 5, Color::Black, p1.buildMoveHash(5, 5, Color::Black));
	p1.makeMove(6, 6, Color::White, p1.buildMoveHash(6, 6, Color::White));
	p1.makeMove(7, 7, Color::Black, p1.buildMoveHash(7, 7, Color::Black));

	GameBoard b2(19, Color::Black);
	SearchPosition19 p2 = SearchPosition19::fromBoard(b2);
	p2.makeMove(7, 7, Color::Black, p2.buildMoveHash(7, 7, Color::Black));
	p2.makeMove(6, 6, Color::White, p2.buildMoveHash(6, 6, Color::White));
	p2.makeMove(5, 5, Color::Black, p2.buildMoveHash(5, 5, Color::Black));
