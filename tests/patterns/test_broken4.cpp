...
TEST_CASE("broken4: B _ B B B (hole pos 1) returns 1 — all 5 query positions")
{
	...
	SUBCASE("query from stone at x=3")
	{
		CHECK(check_four_align_19(board.black, board.white, 3, 5) == 1);
	}
	SUBCASE("query from hole  at x=4")
	{
		CHECK(check_four_align_19(board.black, board.white, 4, 5) == 1);
	}
	SUBCASE("query from stone at x=5")
	{
		CHECK(check_four_align_19(board.black, board.white, 5, 5) == 1);
	}
	SUBCASE("query from stone at x=6")
	{
		CHECK(check_four_align_19(board.black, board.white, 6, 5) == 1);
	}
	SUBCASE("query from stone at x=7")
	{
		CHECK(check_four_align_19(board.black, board.white, 7, 5) == 1);
	}
}
...
TEST_CASE("broken4: B B _ B B (hole pos 2) returns 2 — all 5 query positions")
{
	...
	SUBCASE("query from stone at x=3")
	{
		CHECK(check_four_align_19(board.black, board.white, 3, 5) == 2);
	}
	SUBCASE("query from stone at x=4")
	{
		CHECK(check_four_align_19(board.black, board.white, 4, 5) == 2);
	}
	SUBCASE("query from hole  at x=5")
	{
		CHECK(check_four_align_19(board.black, board.white, 5, 5) == 2);
	}
	SUBCASE("query from stone at x=6")
	{
		CHECK(check_four_align_19(board.black, board.white, 6, 5) == 2);
	}
	SUBCASE("query from stone at x=7")
	{
		CHECK(check_four_align_19(board.black, board.white, 7, 5) == 2);
	}
}
...
TEST_CASE("broken4: B B B _ B (hole pos 3) returns 3 — all 5 query positions")
{
	...
	SUBCASE("query from stone at x=3")
	{
		CHECK(check_four_align_19(board.black, board.white, 3, 5) == 3);
	}
	SUBCASE("query from stone at x=4")
	{
		CHECK(check_four_align_19(board.black, board.white, 4, 5) == 3);
	}
	SUBCASE("query from stone at x=5")
	{
		CHECK(check_four_align_19(board.black, board.white, 5, 5) == 3);
	}
	SUBCASE("query from hole  at x=6")
	{
		CHECK(check_four_align_19(board.black, board.white, 6, 5) == 3);
	}
	SUBCASE("query from stone at x=7")
	{
		CHECK(check_four_align_19(board.black, board.white, 7, 5) == 3);
	}
}
