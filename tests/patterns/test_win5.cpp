...
TEST_CASE("win5: 5 horizontal — detected from every stone position")
{
	...
	SUBCASE("query from x=3")
	{
		CHECK(isWin_ultra_19(board.black, 3, 5) != 0);
	}
	SUBCASE("query from x=4")
	{
		CHECK(isWin_ultra_19(board.black, 4, 5) != 0);
	}
	SUBCASE("query from x=5")
	{
		CHECK(isWin_ultra_19(board.black, 5, 5) != 0);
	}
	SUBCASE("query from x=6")
	{
		CHECK(isWin_ultra_19(board.black, 6, 5) != 0);
	}
	SUBCASE("query from x=7")
	{
		CHECK(isWin_ultra_19(board.black, 7, 5) != 0);
	}
}
...
TEST_CASE("win5: 5 vertical — detected from every stone position")
{
	...
	SUBCASE("query from y=3")
	{
		CHECK(isWin_ultra_19(board.black, 5, 3) != 0);
	}
	SUBCASE("query from y=4")
	{
		CHECK(isWin_ultra_19(board.black, 5, 4) != 0);
	}
	SUBCASE("query from y=5")
	{
		CHECK(isWin_ultra_19(board.black, 5, 5) != 0);
	}
	SUBCASE("query from y=6")
	{
		CHECK(isWin_ultra_19(board.black, 5, 6) != 0);
	}
	SUBCASE("query from y=7")
	{
		CHECK(isWin_ultra_19(board.black, 5, 7) != 0);
	}
}
...
TEST_CASE("win5: 5 diagonal-backslash (\\)")
{
	...
	SUBCASE("query from start")
	{
		CHECK(isWin_ultra_19(board.black, 3, 3) != 0);
	}
	SUBCASE("query from middle")
	{
		CHECK(isWin_ultra_19(board.black, 5, 5) != 0);
	}
	SUBCASE("query from end")
	{
		CHECK(isWin_ultra_19(board.black, 7, 7) != 0);
	}
}
...
TEST_CASE("win5: 5 diagonal-slash (/)")
{
	...
	SUBCASE("query from start")
	{
		CHECK(isWin_ultra_19(board.black, 7, 3) != 0);
	}
	SUBCASE("query from middle")
	{
		CHECK(isWin_ultra_19(board.black, 5, 5) != 0);
	...
	SUBCASE("query from end")
	{
		CHECK(isWin_ultra_19(board.black, 3, 7) != 0);
	}
}
