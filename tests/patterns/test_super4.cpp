...
TEST_CASE("super4: empty board returns 0")
{
    ...
    CHECK(check_super4_19(board.black, board.white, 9, 9) == 0);
}
...
TEST_CASE("super4: only 4 stones (missing one anchor) returns 0")
{
    ...
    CHECK(check_super4_19(board.black, board.white, 5, 5) == 0);
}
...
TEST_CASE("super4: horizontal B _ B B B _ B — detected from every cell in window")
{
    ...
    SUBCASE("query from stone at x=3") { CHECK(check_super4_19(board.black, board.white, 3, 5) == 1); }
    SUBCASE("query from hole  at x=4") { CHECK(check_super4_19(board.black, board.white, 4, 5) == 1); }
    SUBCASE("query from stone at x=5") { CHECK(check_super4_19(board.black, board.white, 5, 5) == 1); }
    SUBCASE("query from stone at x=6") { CHECK(check_super4_19(board.black, board.white, 6, 5) == 1); }
    SUBCASE("query from stone at x=7") { CHECK(check_super4_19(board.black, board.white, 7, 5) == 1); }
    SUBCASE("query from hole  at x=8") { CHECK(check_super4_19(board.black, board.white, 8, 5) == 1); }
    SUBCASE("query from stone at x=9") { CHECK(check_super4_19(board.black, board.white, 9, 5) == 1); }
}
...
TEST_CASE("super4: opponent in both holes blocks detection")
{
    ...
    set_bb19(board.black, 9, 5);
    CHECK(check_super4_19(board.black, board.white, 6, 5) == 0);
}
...
TEST_CASE("super4: vertical B _ B B B _ B returns 1")
{
    ...
    CHECK(check_super4_19(board.black, board.white, 5, 5) == 1);
}
...
TEST_CASE("super4: diagonal-slash B _ B B B _ B returns 1")
{
    ...
    CHECK(check_super4_19(board.black, board.white, 7, 5) == 1);
}
...
TEST_CASE("super4: white B _ B B B _ B detected on white board")
{
    ...
    CHECK(check_super4_19(board.white, board.black, 5, 5) == 1);
}
...
TEST_CASE("super4: black stones do not show on white-side query")
{
    ...
    set_bb19(board.black, 7, 5);
    set_bb19(board.black, 9, 5);
    CHECK(check_super4_19(board.white, board.black, 5, 5) == 0);
}
