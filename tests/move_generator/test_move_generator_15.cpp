...
{
	std::cout << TITLE_LINE << "TEST_CASE [15x15] MoveGenerator: empty board has no active-zone legal moves" << RESET
			  << std::endl;
...
{
	std::cout << TITLE_LINE << "TEST_CASE [15x15] MoveGenerator: center stone radius=1 produces eight legal moves"
			  << RESET << std::endl;
...
{
	std::cout << TITLE_LINE << "TEST_CASE [15x15] MoveGenerator: center stone radius=2 produces twenty-four legal moves"
			  << RESET << std::endl;
	GameBoard b = empty_board();
...
{
	std::cout << TITLE_LINE << "TEST_CASE [15x15] MoveGenerator: corner stone radius=1 clips to board" << RESET
			  << std::endl;
...
{
	std::cout << TITLE_LINE << "TEST_CASE [15x15] MoveGenerator: corner stone radius=2 clips to board" << RESET
			  << std::endl;
...
{
	std::cout << TITLE_LINE << "TEST_CASE [15x15] MoveGenerator: adjacent occupied cells stay excluded" << RESET
			  << std::endl;
...
{
	std::cout << TITLE_LINE << "TEST_CASE [15x15] MoveGenerator: isLegalMove rejects out-of-board and occupied cells"
			  << RESET << std::endl;
...
{
	std::cout << TITLE_LINE << "TEST_CASE [15x15] MoveGenerator: generateMoves: double-three move is absent from result"
			  << RESET << std::endl;
	GameBoard b = empty_board();
...
{
	std::cout << TITLE_LINE
			  << "TEST_CASE [15x15] MoveGenerator: generateMoves: single free-three move is present in result" << RESET
			  << std::endl;
	GameBoard b = empty_board();
	place(b, 3, 9, CellStatus::Black);
	place(b, 4, 9, CellStatus::Black);
...
{
	std::cout << TITLE_LINE << "[15x15] MoveGenerator: double-three is legal when move also captures" << RESET
			  << std::endl;
	GameBoard b = empty_board();
...
{
	std::cout << TITLE_LINE
			  << "[15x15] MoveGenerator: vertical arm at top edge is not a free-three — candidate is legal" << RESET
			  << std::endl;
	GameBoard b = empty_board();
...
{
	std::cout << TITLE_LINE
			  << "[15x15] MoveGenerator: generateMoves: double-three without capture is absent from result" << RESET
			  << std::endl;
	GameBoard b = empty_board();
...
{
	std::cout << TITLE_LINE
			  << "[15x15] MoveGenerator: generateMoves: double-three with diagonal capture is present in result"
			  << RESET << std::endl;
	GameBoard b = empty_board();
	place(b, 5, 2, CellStatus::Black);
	place(b, 5, 3, CellStatus::Black);
...
{
	std::cout << TITLE_LINE
			  << "[15x15] MoveGenerator: double-three with insufficient capture (lone white, no anchor) is absent"
			  << RESET << std::endl;
	GameBoard b = empty_board();
