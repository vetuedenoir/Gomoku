...
TEST_CASE("TEST_CASE [19x19] MoveGenerator: empty board has no active-zone legal moves")
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: empty board has no active-zone legal moves" << RESET << std::endl;
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: center stone radius=1 produces eight legal moves" << RESET << std::endl;
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: center stone radius=2 produces twenty-four legal moves" << RESET << std::endl;
    GameBoard b = empty_board();
    place(b, 9, 9, CellStatus::Black);
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: corner stone radius=1 clips to board" << RESET << std::endl;
    GameBoard b = empty_board();
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: corner stone radius=2 clips to board" << RESET << std::endl;
    GameBoard b = empty_board();
    place(b, 0, 0, CellStatus::Black);
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: adjacent occupied cells stay excluded" << RESET << std::endl;
    GameBoard b = empty_board();
    place(b, 9,  9, CellStatus::Black);
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: isLegalMove rejects out-of-board and occupied cells" << RESET << std::endl;
    GameBoard b = empty_board();
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: double-three move is absent from result" << RESET << std::endl;
    GameBoard b = empty_board();
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: single free-three move is present in result" << RESET  << std::endl;
    GameBoard b = empty_board();
    place(b, 3, 9, CellStatus::Black);
    place(b, 4, 9, CellStatus::Black);
...
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: double-three is legal when move also captures" << RESET << std::endl;
...
TEST_CASE("TEST_CASE [19x19] MoveGenerator: double-three with vertical arm touching top edge is legal because it has only a horizontal free-three")
{
    std::cout << TITLE_LINE << "TEST_CASE [19x19] MoveGenerator: double-three with vertical arm touching top edge is legal because it has only a horizontal free-three" << RESET << std::endl;
    GameBoard b = empty_board();
...
{
    std::cout << TITLE_LINE << "[19x19] MoveGenerator: generateMoves: double-three without capture is absent from result" << RESET << std::endl;
    GameBoard b = empty_board();
...
{
    std::cout << TITLE_LINE << "[19x19] MoveGenerator: generateMoves: double-three with capture is present in result" << RESET << std::endl;
    GameBoard b = empty_board();
...
{
    std::cout << TITLE_LINE << "[19x19] MoveGenerator: double-three with insufficient capture (lone white, no anchor) is absent" << RESET << std::endl;
    GameBoard b = empty_board();
